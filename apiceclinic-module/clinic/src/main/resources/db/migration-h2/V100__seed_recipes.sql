-- V12 H2: Seed 20 fit recipes for the clinic
...
('Bowl di Quinoa con Verdure Arrosto',
 ...
 '1. Cuocere la quinoa. 2. Arrostire le verdure a 200C per 20 min. 3. Unire tutto e condire con olio e spezie.',
 380, 'VEGETARIANO'),
...
('Zuppa di Lenticchie Rosse e Curcuma',
 ...
 '1. Soffriggere cipolla, carote, sedano. 2. Aggiungere lenticchie e brodo. 3. Cuocere 20 min. 4. Frullare meta zuppa per una consistenza cremosa.',
 270, 'LEGUMI'),
...
('Merluzzo al Forno con Patate Dolci',
 ...
 '1. Tagliare le patate dolci a cubetti e arrostire a 200C per 15 min. 2. Aggiungere il merluzzo e cuocere altri 15 min. 3. Servire con limone.',
 330, 'PESCE'),
...
('Burger di Ceci e Spinaci',
 'Hamburger vegetale proteico, ottima alternativa ai burger di carne.',
...
('Yogurt Greco con Frutti di Bosco e Miele',
 'Spuntino proteico e probiotico, ideale a meta mattina o come dessert.',
...
('Crema di Zucca e Zenzero',
 'Zuppa vellutata ipocalorica ricca di betacarotene e proprieta antinfiammatorie.',
...
('Insalata Nizzarda Fit',
 'Versione leggera della classica salade nicoise, completa e bilanciata.',
