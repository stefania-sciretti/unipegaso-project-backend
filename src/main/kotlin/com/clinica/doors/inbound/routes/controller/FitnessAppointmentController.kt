package com.clinica.fitnessappointment.doors.inbound.routes
...
class FitnessAppointmentController(private val fitnessAppointmentService: FitnessAppointmentServicePort) {
